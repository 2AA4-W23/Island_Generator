...
public class IrregularSpecificationLogic implements Buildable {

    private final int width, height, nbTiles, relax;
    public IrregularSpecificationLogic(int width, int height, int nbTiles, int relax) {
     ...
     IrregularSpecificationLogic(Map<String, String> options){
